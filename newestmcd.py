...
def create_signup_box():
    global full_name_entry, age_entry, sex_var, email_entry, password_entry, signup_box, root  # Add root to the global variables
...
def create_admin_login_box():
    global admin_email_entry, admin_password_entry, admin_login_window, root  # Add root to the global variables
...
def admin_appointment_window(full_name, age, sex):
