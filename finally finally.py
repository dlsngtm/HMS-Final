...
def create_signup_box():
    ...
    # Background Image
    background_image = Image.open("signup.png")
...
def create_admin_login_box():
    ...
    # Logo Image
    logo_image = Image.open("logo.png")  # Replace with the path to your logo
...
def create_admin_window(cursor, mydb):
    ...
    def create_search_window():
        ...
        # Back Button
        back_button_path = "back.png"  # Provide the path to your back button image
...
def open_appointment_window(full_name, age, sex):
    ...
    background_image = Image.open(r"appt.png")
...
def display_homepage():
    ...
    hms_info_button = tk.Button(text="About HMS", command=hms_info, bg="#800080", fg="white", width=15)
