...
def create_signup_box():
    ...
    signup_box.geometry("400x410")

    signup_box.configure(bg="lavender")
    tk.Label(signup_box, text="Sign Up", font=("Arial", 16), bg="lavender").pack(pady=10)

    full_name_label = tk.Label(signup_box, text="Full Name:", anchor="w", bg='lavender')
    full_name_label.pack()
    full_name_entry = tk.Entry(signup_box)
    full_name_entry.pack(pady=10)

    age_label = tk.Label(signup_box, text="Age:", anchor="w", bg='lavender')
    age_label.pack()
...
def create_admin_login_box():
    ...
    admin_login_box.geometry("250x200")
...
def admin_appointment_window(cursor, mydb):
    ...
    admin_window.geometry("700x475")  # Adjusted size
...
def hms_info():
    ...
    info_label = tk.Label(info_window, text="Hospital Management System (HMS) is a ...", font=("Arial", 12))
    info_label.pack(pady=20)

    # You can add more widgets and information as needed

    # Add a button to close the info window and show the main window
    close_button = tk.Button(info_window, text="Close", command=lambda: show_main_window_from_info(info_window))
    close_button.pack()
...
def appointment_window(full_name, age, sex):
    ...
    appointment_window.geometry("500x550")
...
background_image = Image.open("D:\DELL E7450\Desktop\Final Project\HMNAS-main\HMNAS-main\chloie.png")
