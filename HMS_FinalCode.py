...
def create_login_box():
    ...
    # Background Image
    background_image = Image.open(r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\login.png")
    ...
    # Logo Image
    logo_image = Image.open(r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\logo.png")
...
def create_signup_box():
    ...
    # Background Image
    background_image = Image.open(r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\signup.png")
...
def create_admin_window(cursor, mydb):
    ...
    def create_search_window():
        ...
        search_logo_path = r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\search.png"
        ...
        # Back Button
        back_button_path = r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\back.png"
...
def open_appointment_window(full_name, age, sex):
    ...
    background_image = Image.open(r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\appt.png")
...
def show_appointment_summary(appointment_info):
    ...
    def update_appointment():
        ...
        def open_date_picker():
            ...
            date_picker_window = tk.Toplevel(update_window)
            date_picker_window.title("Choose a Date")

            # Function to update the selected date and close the date picker window
            ...
            cal = Calendar(date_picker_window, selectmode="day", year=2023, month=1, day=1)
            cal.pack(pady=20)

            # Create a button to update the selected date
        ...
        for key, value in appointment_info.items():
            ...
            if key == "Reason":
            ...
            elif key == "Appointment Date":
                label = tk.Label(update_window, text=f"{key}:", font=("Arial", 12))
                label.grid(row=row_index, column=0, pady=5, padx=(10, 0), sticky="w")

                date_var = tk.StringVar(value=value)
                date_entry = tk.Entry(update_window, textvariable=date_var, font=("Arial", 12), state="disabled")
                date_entry.grid(row=row_index, column=1, pady=5, padx=10, sticky="w")

                # Create a button to open the date picker
                date_picker_button = tk.Button(update_window, text="Pick Date", command=open_date_picker, bg="#f44336", fg="white", font=("Arial", 12))
                ...
                elif key in ["Name", "Contact Number"]:
                    entry.insert(0, value)
                    entry.configure(state="disabled")  # Disable the entry for Name and Contact Number
                else:
                    entry.insert(0, value)
...
background_image = Image.open(r"D:\DELL E7450\Desktop\Final Project\HMS (Final)\homepage.png")
